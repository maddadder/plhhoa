const BASE_URI = process.env.baseUri || "https://plhhoa.azurewebsites.net";
exports.creds = {
	// Required
	identityMetadata: 'https://login.microsoftonline.com/leenet.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
	...
	redirectUrl: BASE_URI + '/auth/openid/return', 
  ...
  exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=' + BASE_URI;
